...
DATABASE_NAME = 'simplified_query_processor'

def getOpenConnection(user='postgres', password='1234', dbname='simplified_query_processor'):
    return psycopg2.connect("dbname='" + dbname + "' user='" + user + "' host='localhost' password='" + password + "'")

def createDB(dbname='simplified_query_processor'):
    """
